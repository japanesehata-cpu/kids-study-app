...
export interface KanjiEntry {
  ...
  meaningJa?: string
  meaningEn?: string
  /** Short natural sentence using this kanji in context, shown (and read aloud) on
   * KanjiTraceScreen's review pass — the "see it for real, not just in isolation" step
   * that follows a full lap of tracing every kanji in the pool. Set together with
   * traceImageId/meaningJa/meaningEn, never alone. Written with only this kanji plus kana
   * (no other kanji character) since review only assumes this one character has been
   * learned so far. */
...
export const kanjiBank: KanjiEntry[] = [
  ...
  // readings which overlap heavily, e.g. 日/火 both read ひ)
  {
    ...
    meaningJa: 'たいよう',
    meaningEn: 'sun',
    exampleSentenceJa: 'あさ、日が のぼりました。',
    exampleSentenceEn: 'The sun rose in the morning.',
  },
  {
    id: 'k12',
    char: '月',
    ...
    meaningJa: 'つき',
    meaningEn: 'moon',
    exampleSentenceJa: 'よるに 月が でました。',
    exampleSentenceEn: 'The moon came out at night.',
  },
  { id: 'k13', char: '火', reading: 'か', row: 'nature', mnemonic: 'かようび' },
  {
    ...
    meaningJa: 'みず',
    meaningEn: 'water',
    exampleSentenceJa: '水を いっぱい のみました。',
    exampleSentenceEn: 'I drank a lot of water.',
  },
  {
    id: 'k15',
    char: '木',
    ...
    meaningJa: 'き',
    meaningEn: 'tree',
    exampleSentenceJa: '木に とりが とまりました。',
    exampleSentenceEn: 'A bird landed on the tree.',
  },
  {
    id: 'k16',
    char: '金',
    ...
    meaningJa: 'きんいろ',
    meaningEn: 'gold',
    exampleSentenceJa: '金の コインを ひろいました。',
    exampleSentenceEn: 'I picked up a gold coin.',
  },
  ...
  { id: 'k18', char: '空', reading: 'そら', row: 'nature', mnemonic: 'そらまめ' },
  {
    ...
    meaningJa: 'あめ',
    meaningEn: 'rain',
    exampleSentenceJa: '雨が ざあざあ ふっています。',
    exampleSentenceEn: 'The rain is pouring down.',
  },
  ...
  // animals & nature
  {
    ...
    meaningJa: 'いぬ',
    meaningEn: 'dog',
    exampleSentenceJa: '犬が わんわん ないています。',
    exampleSentenceEn: 'The dog is barking woof woof.',
  },
  {
    id: 'k52',
    char: '貝',
  ...
  { id: 'k53', char: '虫', reading: 'むし', row: 'animals', mnemonic: 'むしめがね' },
  {
    ...
    meaningJa: 'いし',
    meaningEn: 'rock',
    exampleSentenceJa: '石を なげて あそびました。',
    exampleSentenceEn: 'I played by throwing stones.',
  },
  {
    id: 'k55',
    char: '花',
    ...
    meaningJa: 'はな',
    meaningEn: 'flower',
    exampleSentenceJa: '花が きれいに さきました。',
  ...
  },
  {
    ...
    meaningJa: 'くさ',
    meaningEn: 'grass',
    exampleSentenceJa: '草の うえで ねころびました。',
    exampleSentenceEn: 'I lay down on the grass.',
  },
  { id: 'k57', char: '竹', reading: 'たけ', row: 'animals', mnemonic: 'たけのこ' },
  {
    ...
    meaningJa: 'もり',
    meaningEn: 'forest',
    exampleSentenceJa: '森の なかを あるきました。',
    exampleSentenceEn: 'I walked through the forest.',
  },
  { id: 'k59', char: '林', reading: 'はやし', row: 'animals', mnemonic: 'はやしのなか' },
  {
    ...
    row: 'animals',
    mnemonic: 'やまのぼり',
    traceImageId: 'mountain',
    meaningJa: 'やま',
    meaningEn: 'mountain',
    exampleSentenceJa: '山に のぼりました。',
  ...
  // places & daily life
  {
    ...
    meaningJa: 'かわ',
    meaningEn: 'river',
    exampleSentenceJa: '川で さかなを つりました。',
    exampleSentenceEn: 'I caught a fish in the river.',
  },
  ...
  { id: 'k68', char: '玉', reading: 'たま', row: 'places', mnemonic: 'たまねぎ' },
  {
    ...
    meaningJa: 'くるま',
    meaningEn: 'car',
    exampleSentenceJa: '車に のって でかけました。',
    exampleSentenceEn: 'I got in the car and went out.',
  },
  ...
  { id: 'k78', char: '文', reading: 'ぶん', row: 'study', mnemonic: 'ぶんぼうぐ' },
  {
    ...
    meaningJa: 'ほん',
    meaningEn: 'book',
    exampleSentenceJa: '本を たくさん よみました。',
    exampleSentenceEn: 'I read many books.',
  },
