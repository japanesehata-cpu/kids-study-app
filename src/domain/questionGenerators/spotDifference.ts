...
/** Colors are abstract swatches, not scene-like objects, so they're excluded — every icon
 * used here is a real animal/food/nature/vehicle photo (see REALISTIC_STYLE_GUARDRAIL),
 * reused as-is rather than generating any new art for this category. */
const ICON_POOL = wordBank.filter((w) => w.category !== 'color')
